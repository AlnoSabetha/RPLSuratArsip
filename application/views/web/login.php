					...
					<form action="" method="post">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div class="icon-object border-slate-300 text-slate-300"><img src="assets/33.UKDW.png" alt="Logo Surat Menyurat" width="75"></div>
								<h5 class="content-group">Sistem Informasi Surat Menyurat FTI<small class="display-block">Silahkan Masuk</small></h5>
								<?php
