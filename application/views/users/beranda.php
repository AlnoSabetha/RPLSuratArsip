      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card text-white  mb-3" style="max-width: 18rem;">
                ...
                <a href="suratpersonalia.php" style="color:#f1f1f1;text-align:center;">
                <div id="server-load" style="border:1px solid #222;padding:10px;background:#333;">
                    Surat SK <i class="icon-circle-right2"></i>
                </div>
                </a>
                <a href="suratketerangan.php" style="color:#f1f1f1;text-align:center;">
                <div id="server-load" style="border:1px solid #222;padding:10px;background:#333;">
                   Surat Keterangan <i class="icon-circle-right2"></i>
                </div>
                </a>
                <a href="suratundangan.php" style="color:#f1f1f1;text-align:center;">
                <div id="server-load" style="border:1px solid #222;padding:10px;background:#333;">
                    Surat Undangan <i class="icon-circle-right2"></i>
                </div>
                </a>
                <a href="surattugas.php" style="color:#f1f1f1;text-align:center;">
                <div id="server-load" style="border:1px solid #222;padding:10px;background:#333;">
                    Surat Tugas <i class="icon-circle-right2"></i>
                </div>
                </a>
                <a href="suratberita.php" style="color:#f1f1f1;text-align:center;">
                <div id="server-load" style="border:1px solid #222;padding:10px;background:#333;">
                    Surat Berita <i class="icon-circle-right2"></i>
                </div></div></div>
               <!-- /current server load -->
              </div>
              <div class="col-lg-6">
