				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
		                ...
		                if ($user->row()->level == 's_admin') { ?>
								...
								<li class="<?php if ($sub_menu == "sk" or $sub_menu == "sm") { echo 'active';}?>">
									<a href="tampil.php"><i class="icon-file-spreadsheet"></i> <span>ARSIP SURAT</span></a>
								</li>
								<li class="<?php if ($sub_menu == "sk" or $sub_menu == "sm") { echo 'active';}?>">
										<a href="#"><i class="icon-file-spreadsheet"></i> <span>PENGAJUAN SURAT</span></a>
									<ul>
										<li class="<?php if ($sub_menu == "sm") { echo 'active';}?>"><a href="suratberita.php"><i class="icon-folder-download2"></i> SURAT BERITA</a></li>
										<li class="<?php if ($sub_menu == "sk") { echo 'active';}?>"><a href="suratketerangan.php"><i class="icon-folder-upload2"></i> SURAT KETERANGAN</a></li>
										<li class="<?php if ($sub_menu == "sk") { echo 'active';}?>"><a href="suratpersonalia.php"><i class="icon-folder-upload2"></i> SURAT PERSONALIA</a></li>
										<li class="<?php if ($sub_menu == "sk") { echo 'active';}?>"><a href="surattugas.php"><i class="icon-folder-upload2"></i> SURAT TUGAS</a></li>
										<li class="<?php if ($sub_menu == "sk") { echo 'active';}?>"><a href="suratundangan.php"><i class="icon-folder-upload2"></i> SURAT UNDANGAN</a></li>
									</ul>
								</li>
