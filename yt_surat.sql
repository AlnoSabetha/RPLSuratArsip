...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2021 at 03:25 AM
...
(32, 'ff10e2d4ab77d989348cc7411181d173', 'Intan_Kusumawardani_1201174423_TI-41-05_(2).pdf', '627.69'),
(33, '7cb6e8bba78b75ad6002bbbc551afbd3', '239-Article_Text-447-1-10-20200604.pdf', '310.56'),
(34, 'd1c5fcce8bf096a1f79c6552352984f5', 'STUDI_KASUS_RPL_2021-5.pdf', '236.63'),
(35, '56ba5b8a0a1a1d615cf592363435df6f', 'STUDI_KASUS_RPL_2021-51.pdf', '236.63'),
(36, '2c68df0ba2193ab32de8ddddf2a55c32', 'STUDI_KASUS_RPL_2021-52.pdf', '236.63');
...
(18, 'FTI/001', '02-11-2021', '', '', 'Minta tanda tangan berita acara', 0, 'd1c5fcce8bf096a1f79c6552352984f5', 6, 1, 'Dekan', 0, '02-11-2021');
...
(5, 'admin', 'c84258e9c39059a89ab77d846ddab909', 'Admin', 'Ianneclara@gmail.com', 'Sorong', '4646546', 'ok', 'admin', 'aktif', '01-11-2021 11:35:29', '03-11-2021 09:01:15'),
(6, 'mahasiswa@gmail.com', 'ee11cbb19052e40b07aac0ca060c23ee', 'Manuel Vallancio Nugroho', 'manuelvallancio@gmail.com', 'Klaten', '0987775', 'ok', 'user', 'aktif', '01-11-2021 11:35:05', '03-11-2021 09:01:53');
...
--
ALTER TABLE `tbl_lampiran`
  MODIFY `id_lampiran` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `tbl_sk`
  MODIFY `id_sk` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
