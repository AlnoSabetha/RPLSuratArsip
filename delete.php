...
if(isset($_GET['Nim'])){
	...
	if(mysqli_num_rows($cek) > 0){
		...
		if($del){
			echo '<script>alert("Berhasil menghapus data."); document.location="tampil.php?page=tampil_mhs";</script>';
		}else{
			echo '<script>alert("Gagal menghapus data."); document.location="tampil.php?page=tampil_mhs";</script>';
		}
	}else{
